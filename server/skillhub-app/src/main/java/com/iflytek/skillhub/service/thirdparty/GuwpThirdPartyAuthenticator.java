...
@Component
public class GuwpThirdPartyAuthenticator extends AbstractThirdPartyTokenAuthenticator {

    private static final Logger log = LoggerFactory.getLogger(GuwpThirdPartyAuthenticator.class);
    private static final ThirdPartyLoginPlatform PLATFORM = ThirdPartyLoginPlatform.GUWP;
